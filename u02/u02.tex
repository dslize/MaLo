...
%\noindent Für beide Fälle gilt nach der Definition $(\mathfrak{I_1} \cap \mathfrak{I_2}) = \min(\mathfrak{I_1}, \mathfrak{I_2})$: falls $\mathfrak{I_1} \models \psi_i$ und $\mathfrak{I_2} %\models \psi_i$, dann $(\mathfrak{I_1} \cap \mathfrak{I_2}) \models \psi_i$.\\
