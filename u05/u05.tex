...
\begin{adjustwidth}{20pt}{20pt}
	...
	Sei $n \subseteq \mathbb{N}$, $n \neq \emptyset$ und sei $N_2=\{ 2^i \cdot m\ |\ m \in n, i \in \mathbb{N}\}$ sowie $N_k=\{ \mathds{N}\backslash Q \ | \ Q = \{0,..,k\}, \ k \in \mathds{N}\}$ die Teilmengen von $\mathds{N}$ ohne Anfangselemente $0$ bis $k$. Ferner sei $N_n \defgr N_2 \ \cup \ N_k$. Dann ist $\mathfrak{N}_{N_n}=(N_n, f)$ eine Substruktur
